...
var xp_al_morir: float = 15.0
var jugador: Node2D = null
var timer_danio: float = 0.0
var cadencia_danio: float = 1.2
var rango_ataque: float = 45.0
var delay_impacto: float = 0.15
...
func _physics_process(delta: float) -> void:
	...
	if senuelo != null:
		if global_position.distance_to(senuelo.global_position) < 32.0:
